...
This extension is a port of the Google Chrome extension [here](https://github.com/igrigorik/videospeed), written by [Ilya Grigorik](https://github.com/igrigorik).

Follow the instructions [here](https://docs.microsoft.com/en-us/microsoft-edge/extensions/guides/adding-and-removing-extensions) to install the extension manually.
